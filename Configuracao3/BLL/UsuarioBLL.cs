...
namespace BLL
{
    public class UsuarioBLL
    {
        ...
        //    usuario = BuscarPorNomeAcesso(_usuario.NomeUsuario);
            if (new UsuarioDAL().ExisteNomeUsuario(_usuario.NomeUsuario) )
            {
        ...
        private void ValidarDados(Usuario _usuario, string _confirmacaoSenha)
        {
            ...
            if (_usuario.Senha.Length < 6 || _usuario.Senha.Length > 15)
            {
        ...
        public List<Usuario> BuscarUsuarioPorNome(string _nome_busca)
        {
