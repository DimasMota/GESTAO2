...
namespace DAL
{
    public class UsuarioDAL
    {
        ...
        public bool ExisteNomeUsuario(string _nome)
        {
            ...
            try
            {
                cn.ConnectionString = Conexao.StringDeConexao;
                cmd.Connection = cn;
                cmd.CommandText = @"SELECT 1 AS retorno FROM Usuario  WHERE nome_Usuario = @nome ";
                cmd.CommandType = System.Data.CommandType.Text;
        ...
        public List<Usuario> BuscarUsuarioPorNome(string _nome)
        {
            List<Usuario> usuarios = new List<Usuario>();
            Usuario usuario;
            SqlConnection cn = new SqlConnection();
        ...
        public void Excluir(Usuario _id)
        {
            ...
            {
                throw new Exception("Ocorreu um erro ao tentar deletar um usuário no banco " + ex.Message);
            }
            finally
            {
                cn.Close();
        ...
        public void RemoverGrupoUsuario(int _id_usuario, int _id_grupo)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = cn;
                cmd.CommandText = "DELETE FROM Grupo_com_Usuario_N_N WHERE cod_usuario = @id_usuario  AND cod_GrupoUsuario = @id_grupo ";
                cmd.CommandType = System.Data.CommandType.Text;
                cmd.Parameters.AddWithValue("@id_usuario", _id_usuario);
                cmd.Parameters.AddWithValue("@id_grupo", _id_grupo);
                cn.Open();
                cmd.ExecuteScalar();
            }
            catch (Exception ex)
