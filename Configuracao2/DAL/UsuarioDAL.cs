    ...
    public class UsuarioDAL
    {
        ...
        public List<Usuario> BuscarTodos()
        {
            ...
            try
            {
                cn.ConnectionString = Conexao.StringDeConexao;
                cmd.Connection = cn;
                cmd.CommandText = "SELECT id_Usuario, nome_Usuario, ativo, Funcao,Cargo FROM Usuario";
                cmd.CommandType = System.Data.CommandType.Text;
                cn.Open();
                using (SqlDataReader rd = cmd.ExecuteReader())
                {
                  ...
                  //      usuario.Nome = rd["nome"].ToString();
                        ...
                        usuario.Funcao = rd["Funcao"].ToString();
                        usuario.Cargo = rd["Cargo"].ToString();
...
*/
        ...
        public List<Usuario> BuscarTodos_PorId(int _id_Pessoa)
        {
            List<Usuario> usuarios = new List<Usuario>();
            Usuario usuario;
            SqlConnection cn = new SqlConnection();
            ...
            try
            {
                cn.ConnectionString = Conexao.StringDeConexao;
                cmd.Connection = cn;
                cmd.CommandText = "SELECT id_Usuario, nome_Usuario, ativo, Funcao,Cargo FROM Usuario WHERE id_Usuario = @id";
                cmd.Parameters.AddWithValue("@id", _id_Pessoa);
                cmd.CommandType = System.Data.CommandType.Text;
                cn.Open();
                using (SqlDataReader rd = cmd.ExecuteReader())
                {
